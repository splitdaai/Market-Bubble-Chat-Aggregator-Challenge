...
import {X, Sparkles, MessagesSquare, Activity, BarChart3, Trophy, Monitor, Flame,
  ...
  Crosshair, LineChart, Star, Calculator, AtSign, Play, Gamepad2, Wand2 } from "lucide-react";
...
const FEATURES: Feature[] = [
  ...
  { icon: Wand2, title: "FX Lab + Custom Effects", desc: "Tune every overlay effect (duration, intensity, scale, glow) or upload your own PNG — auto-cut to transparent — and turn it into a tappable on-stream effect.", tint: "#a78bfa" },
