...
export function Topbar({ onOpenTheme, onOpenConnections, onOpenFeatures }: { onOpenTheme: () => void; onOpenConnections: () => void; onOpenFeatures: () => void }) {
  ...
  return (
    <header className="relative z-20 flex flex-wrap items-center justify-between gap-y-2 px-3 py-2 sm:px-5">
      <div className="flex items-center gap-3">
        <img src="/market-bubble-logo.svg" alt="Market Bubble" className="h-16 w-auto shrink-0" />
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <motion.a
          ...
          className="ml-1 flex items-center gap-1.5 whitespace-nowrap rounded-xl border border-white/15 bg-white/[0.04] px-3 py-2 text-sm font-bold text-ink transition hover:border-gold/50 hover:text-gold"
        >
