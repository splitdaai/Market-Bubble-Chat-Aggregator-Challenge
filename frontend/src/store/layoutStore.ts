...
const DEFAULT_LAYOUT: Layout = {
  ...
  panels: [
    ...
    { i: "preview-1", widget: "stream-preview", x: 5, y: 0, w: 4, h: 13, minW: 3, minH: 4 },
    // Polymarket markets under the preview.
    { i: "polymarket-1", widget: "polymarket", x: 5, y: 13, w: 4, h: 16, minW: 3, minH: 8 },
    // Chat down the right side.
    { i: "feed-1", widget: "chat-feed", x: 9, y: 0, w: 3, h: 40, minW: 3, minH: 6 },
    // Middle column under Polymarket: consolidated ops + leaderboards + users.
    { i: "ops-1", widget: "ops", x: 5, y: 29, w: 4, h: 13, minW: 3, minH: 8 },
    { i: "chatters-1", widget: "top-chatters", x: 0, y: 40, w: 5, h: 11, minW: 2, minH: 6 },
    { i: "users-1", widget: "user-list", x: 9, y: 40, w: 3, h: 11, minW: 3, minH: 6 },
  ],
};
