...
const DEFAULT_LAYOUT: Layout = {
  version: 1,
  panels: [
    // Top row — Live Stats, stream preview, and chat, all the same height.
    { i: "stats-1", widget: "stats", x: 0, y: 0, w: 4, h: 15, minW: 4, minH: 8 },
    { i: "preview-1", widget: "stream-preview", x: 4, y: 0, w: 5, h: 15, minW: 3, minH: 4 },
    { i: "feed-1", widget: "chat-feed", x: 9, y: 0, w: 3, h: 15, minW: 3, minH: 6 },
    // Bottom row — Users, Leaderboards, Polymarket, Giveaways side by side.
    { i: "users-1", widget: "user-list", x: 0, y: 15, w: 3, h: 13, minW: 3, minH: 6 },
    { i: "chatters-1", widget: "top-chatters", x: 3, y: 15, w: 2, h: 13, minW: 2, minH: 6 },
    { i: "polymarket-1", widget: "polymarket", x: 5, y: 15, w: 4, h: 13, minW: 3, minH: 8 },
    { i: "ops-1", widget: "ops", x: 9, y: 15, w: 3, h: 13, minW: 3, minH: 8 },
  ],
};
